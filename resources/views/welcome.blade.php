                        ...
                        <ul>
                            ...
                            <li>
                                <a href="{{ URL::to('slots') }}" class="game-box ">
                                    ...
                                    <img class="lazy" alt="Gate Of Olympus" src="#" alt="Gate Of Olympus"
                                        data-src="https://files.sitestatic.net/games/i/220x220/4d5007c76503d49d8ef3f96d3cf4a01c.webp" />
                                    <!--TODO alt text-->
                                    <div class="loader-b" *ngIf="!showEle"></div>
                                    <div class=" game-title"><span style="width: 80%;overflow: hidden;">
                                        Gate Of Olympus</span> <img class="logo"
                                            src="https://files.sitestatic.net/assets/imgs/game_providers_logos_sm/pp.png?v=3.2">
                                    </div>
                            ...
                            <li>
                                <a href="{{ URL::to('slots') }}" class="game-box ">
                                    ...
                                    <img class="lazy" alt="Starlight Princess" src="#" alt="Starlight Princess"
                                        data-src="https://files.sitestatic.net/games/i/220x220/c957cd96f3779941ca5755ad5a3e9af0.webp" />
                                    <!--TODO alt text-->
                                    <div class="loader-b" *ngIf="!showEle"></div>
            ...
            overflow: hidden;">Starlight
                            ...
                            <li>
                                <a href="{{ URL::to('slots') }}" class="game-box ">
                                    ...
                                    <img class="lazy" alt="Sweet Bonanza" src="#" alt="Sweet Bonanza"
                                        data-src="https://files.sitestatic.net/games/i/220x220/cf7fdad8713f88703071adaf9a189b74.webp" />
                                    <!--TODO alt text-->
                                    <div class="loader-b" *ngIf="!showEle"></div>
                                    <div class=" game-title"><span
                                            style="    width: 80%;
            overflow: hidden;">Sweet
                            ...
                            <li>
                                <a class="game-box" target="_blank" href="{{ URL::to('https://m.pgf-asw0zz.com/65/index.html?l=id&btt=1&ot=D9DA9230-67DD-17DB-2E38-A3A531C95F00&ops=UABAAAD23TOugpaXwkdtFZcuFgJSksYs17YTAlxckbvfXvcgL2MJITzgjbqT0Dk4C2LlcjGfOfM&__refer=m.pgjksjk.com&or=static.pgf-asw0zz.com&__hv=1fc5b39b') }}" (click)="closeNav($event);">
                                    ...
                                    <div class=" game-title"><span style="width: 80%;overflow: hidden;">
                                            ...
                                            src="https://files.sitestatic.net/assets/imgs/game_providers_logos_sm/pgsoft.png?v=3.2">
                                    </div>
